...
def getRelativePos(footNode, baseNode):
    pass

testLeg = robot.getFromDef("FRONT_LEFT_LEG")
testFoot = robot.getFromDef("FOOTB")

robot.step(int(spot_bot.time_step))

def getPose():
    relativePose = testFoot.getPose(testLeg)
    x, y, z = relativePose[0:4][3], relativePose[4:8][3], relativePose[8:12][3]
    print(x,y,z)
